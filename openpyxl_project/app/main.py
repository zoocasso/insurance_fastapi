...
async def view_portf(request: Request, portf:str):
    ...
    return templates.TemplateResponse("view_data.html", {"request":request, "db_data":db_data, "header_list":header_list, "cell_value":portf})
...
async def view_data(request: Request, ACC_PERIOD:str, ACC_PERIOD_TYPE:str, M_LIAB_ITEM:str, M_ACC_EVENT:str, cell_value:str):
    ...
    mysql_session.db_close()
    return templates.TemplateResponse("view_data.html", {"request":request, "db_data":db_data, "header_list":header_list, "cell_value":cell_value})
