...
class mysql_session:
    ...
    def get_sql_str(self,ACC_PERIOD,ACC_PERIOD_TYPE,M_LIAB_ITEM,M_ACC_EVENT):
        return f"select * from data where ACC_PERIOD = '{ACC_PERIOD}' AND ACC_PERIOD_TYPE = '{ACC_PERIOD_TYPE}' AND M_LIAB_ITEM = {M_LIAB_ITEM} AND M_ACC_EVENT = {M_ACC_EVENT};"
